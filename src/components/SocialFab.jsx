...
const SocialFab = () => {
  ...
  const socialLinks = [
    {
      label: 'LinkedIn',
      url: 'https://linkedin.com/in/deepak-kathiravan', // Replace with actual
    ...
    {
      label: 'Twitter',
      url: 'https://twitter.com/', // Replace with actual
    ...
    {
      label: 'Instagram',
      url: 'https://instagram.com/', // Replace with actual
    ...
    {
      label: 'YouTube',
      url: 'https://youtube.com/', // Replace with actual
    ...
    {
      label: 'Abz Insta',
      url: 'https://instagram.com/abz', // Placeholder
